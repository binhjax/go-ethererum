...
func (srv *Server) Start() (err error) {
	fmt.Println("binhnt.p2pserver","Server.Start()","Start running")
	srv.lock.Lock()
	...
	fmt.Println("binhnt.p2pserver","Server.Start()","Create event channels")
	...
	fmt.Println("binhnt.p2pserver","Server.Start()","setup local node")
	if err := srv.setupLocalNode(); err != nil {
		return err
	}

	fmt.Println("binhnt.p2pserver","Server.Start()","setup Listening")
	if srv.ListenAddr != "" {
	...
	fmt.Println("binhnt.p2pserver","Server.Start()","setup discovery")
	...
	fmt.Println("binhnt.p2pserver","Server.Start()","Create new newDialState")
	dialer := newDialState(srv.localnode.ID(), srv.StaticNodes, srv.BootstrapNodes, srv.ntab, dynPeers, srv.NetRestrict)
	srv.loopWG.Add(1)

	fmt.Println("binhnt.p2pserver","Server.Start()","Create thread run dialer ")
	go srv.run(dialer)
	return nil
}
