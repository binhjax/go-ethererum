...
func NewOracle(backend ethapi.Backend, params Config) *Oracle {
	fmt.Println("binhnt.eth.gasprice.gasprice","NewOracle","create new oracle in order to estimate gasprice")
...
func (gpo *Oracle) SuggestPrice(ctx context.Context) (*big.Int, error) {
	fmt.Println("binhnt.eth.gasprice.gasprice","Oracle.SuggestPrice","suggest gasprice")
