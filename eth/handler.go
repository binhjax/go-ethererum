...
func (pm *ProtocolManager) BroadcastBlock(block *types.Block, propagate bool) {
	log.Debug("binhnt.eth.handler","ProtocolManager.BroadcastBlock"," broadcast block")
	hash := block.Hash()
	peers := pm.peers.PeersWithoutBlock(hash)

	// If propagation is requested, send to a subset of the peer
	if propagate {
		log.Debug("binhnt.eth.handler","ProtocolManager.BroadcastBlock"," If propagation is requested, send to a subset of the peer")
		...
		log.Debug("binhnt.eth.handler","ProtocolManager.BroadcastBlock"," Send the block to a subset of our peers")
