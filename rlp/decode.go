...
func DecodeBytes(b []byte, val interface{}) error {
	//fmt.Println("binhnt.rlp.decode","DecodeBytes"," start code data: ", b," to interface: ", val)
	// TODO: this could use a Stream from a pool.
	//fmt.Println("binhnt.rlp.decode","DecodeBytes"," create io.reader from data")
	r := bytes.NewReader(b)
	//fmt.Println("binhnt.rlp.decode","DecodeBytes"," create NewStream from reader with length = ",uint64(len(b)))
...
func (s *Stream) Decode(val interface{}) error {
	//fmt.Println("binhnt.rlp.decode","Stream.Decode"," start decode a stream" )
	if val == nil {
		return errDecodeIntoNil
	}
	rval := reflect.ValueOf(val)
	//fmt.Println("binhnt.rlp.decode","Stream.Decode"," rval = ",rval )
	rtyp := rval.Type()
	//fmt.Println("binhnt.rlp.decode","Stream.Decode"," rtyp = ",rtyp )
