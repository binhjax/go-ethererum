...
func (c *Client) CallContext(ctx context.Context, result interface{}, method string, args ...interface{}) error {
	fmt.Println("binhnt.rpc.client","Client.CallContext"," create new message with client  ")
	...
	fmt.Println("binhnt.rpc.client","Client.CallContext","method=",method,"msg=",msg)
	if c.isHTTP {
		fmt.Println("binhnt.rpc.client","Client.CallContext"," c.sendHTTP")
		err = c.sendHTTP(ctx, op, msg)
	} else {
			fmt.Println("binhnt.rpc.client","Client.CallContext"," c.send")
