...
func (c *Client) sendHTTP(ctx context.Context, op *requestOp, msg interface{}) error {
	fmt.Println("binhnt.rpc.http","sendHTTP","c.writeConn")
	hc := c.writeConn.(*httpConn)

	fmt.Println("binhnt.rpc.http","sendHTTP","hc.doRequest")
	respBody, err := hc.doRequest(ctx, msg)

	fmt.Println("binhnt.rpc.http","sendHTTP","respBody=",respBody)
	if respBody != nil {
	...
	fmt.Println("binhnt.rpc.http","sendHTTP","respmsg=",respmsg)
	op.resp <- &respmsg
	return nil
}
...
func NewHTTPServer(cors []string, vhosts []string, timeouts HTTPTimeouts, srv *Server) *http.Server {
	fmt.Println("binhnt.rpc.http","NewHTTPServer"," create handle to handler request")
...
func newCorsHandler(srv *Server, allowedOrigins []string) http.Handler {
	...
	fmt.Println("binhnt.rpc.http","newCorsHandler","create http handler")
...
func newVHostHandler(vhosts []string, next http.Handler) http.Handler {
	...
	fmt.Println("binhnt.rpc.http","newVHostHandler"," create virtualHostHandler")
